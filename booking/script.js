...
// // Populate all time slots from 09:00 to 18:00
...
//     const slot = hour < 10 ? `0${hour}:00` : `${hour}:00`;
//     slots.push(slot);
//   }
//   return slots;
// }
...
//   if (!name || !age || !phone || !email || !date || !time || !type || !duration || !counselor || !slot) {
...
//     alert('Please enter a valid phone number (11-14 characters, including optional +).');
//     return;
//   }
...
// populateCounselors();
// populateSlots(); // Initial population of slots
// });
